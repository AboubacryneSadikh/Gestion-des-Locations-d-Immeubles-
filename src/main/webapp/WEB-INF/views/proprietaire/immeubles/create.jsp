...
<c:set var="pageTitle" value="Créer un immeuble" scope="request"/>
...
<div class="main-content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-0">Créer un immeuble</h2>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card form-card">
                <form action="${pageContext.request.contextPath}/proprietaire/immeubles/create" method="post" class="needs-validation" novalidate>
                    <div class="row">
                        <!-- Nom de l'immeuble -->
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" id="nom" name="nom"
                                   value="${nom}" required placeholder="Ex: Résidence Les Palmiers">
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="text" class="form-control" id="adresse" name="adresse"
                                   value="${adresse}" required placeholder="Numéro et nom de la rue">
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="codePostal" name="codePostal"
                                   value="${codePostal}" placeholder="Ex: 75001" pattern="[0-9]{5}">
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" id="ville" name="ville"
                                   value="${ville}" required placeholder="Nom de la ville">
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description"
                                      rows="4" placeholder="Décrivez l'immeuble (standing, environnement, particularités...)">${description}</textarea>
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <textarea class="form-control" id="equipements" name="equipements"
                                      rows="3" placeholder="Ascenseur, parking, gardien, interphone, etc.">${equipements}</textarea>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="alert alert-light border">
                                ...
                                <p class="mb-0">
                                    Après avoir créé cet immeuble, vous pourrez ajouter les unités de location
                                    (appartements, locaux commerciaux, etc.) dans la section "Mes unités".
                                </p>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    // Auto-formatage du nom de l'immeuble (première lettre en majuscule)
    ...
    // Auto-formatage de la ville (première lettre en majuscule)
